var Module = (() => {
    return async function (moduleArg = {}) {
        ...
        function findWasmBinary() {
            if (Module["locateFile"]) {
                return locateFile("dilithium.wasm");
            }
            return new URL("dilithium.wasm", import.meta.url).href;
        }
        ...
        var _crypto_sign_keypair_wrapper = (Module[
            "_crypto_sign_keypair_wrapper"
        ] = wasmExports["g"]);
        var _crypto_sign_wrapper = (Module["_crypto_sign_wrapper"] =
            wasmExports["h"]);
        var _crypto_verify_wrapper = (Module["_crypto_verify_wrapper"] =
            wasmExports["i"]);
